  ...
  return (
    <div className="py-2">
      <div className="flex items-center">
        ...
        <button
          className="bg-blue-200 hover:bg-blue-300 duration-150 px-4 py-2 rounded shadow mr-2"
          onClick={increment}
        >
          +
        </button>
        <button
          className="bg-gray-200 hover:bg-gray-300 duration-150 px-4 py-2 rounded shadow "
          onClick={reset}
        >
          Reset
        </button>
